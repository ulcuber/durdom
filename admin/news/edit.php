            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-default table-responsive">
                        <div class="panel-heading">Редактировать новость #<?=$item['id']?></div>

<form class="form-horizontal"
    method="POST"
    action="<?=url('admin/news/update.php')?>"
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                <img class="img-responsive" src="<?=url('images/news/' . $item['imghead'])?>" alt="<?=$item['head']?>">
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                <img class="img-responsive" src="<?=url('images/news/' . $item['img'])?>" alt="<?=$item['head']?>">
            </div>
        </div>
        <div class="form-group">
